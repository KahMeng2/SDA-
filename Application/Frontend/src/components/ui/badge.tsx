...
// Helper function to determine badge variant based on funding application state
export function getFundingApplicationBadgeVariant(state: string): BadgeProps['variant'] {
  switch (state) {
    case 'ApprovedState':
      return 'success';
    case 'RejectedState':
